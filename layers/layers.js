...
var format_to__13 = new ol.format.GeoJSON();
var features_to__13 = format_to__13.readFeatures(json_to__13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_to__13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_to__13.addFeatures(features_to__13);
var lyr_to__13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_to__13, 
                style: style_to__13,
                popuplayertitle: 'الالكترونيات — to_',
                interactive: true,
                title: '<img src="styles/legend/to__13.png" /> الالكترونيات — to_'
            });
var format_3400900007_14 = new ol.format.GeoJSON();
var features_3400900007_14 = format_3400900007_14.readFeatures(json_3400900007_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_3400900007_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_3400900007_14.addFeatures(features_3400900007_14);
var lyr_3400900007_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_3400900007_14, 
                style: style_3400900007_14,
                popuplayertitle: '3400900007',
                interactive: true,
                title: '<img src="styles/legend/3400900007_14.png" /> 3400900007'
            });
var group_halls = new ol.layer.Group({
                                layers: [lyr_3400900007_14,],
                                fold: 'open',
                                title: 'halls'});
...
lyr_GoogleSatellite_0.setVisible(true);lyr__1.setVisible(true);lyr__2.setVisible(true);lyr__3.setVisible(true);lyr__4.setVisible(true);lyr__5.setVisible(true);lyr__6.setVisible(true);lyr__7.setVisible(true);lyr__8.setVisible(true);lyr__9.setVisible(true);lyr__10.setVisible(true);lyr__11.setVisible(true);lyr__12.setVisible(true);lyr_to__13.setVisible(true);lyr_3400900007_14.setVisible(true);
...
lyr_to__13.set('fieldAliases', {'fid': 'fid', 'id': 'id', });
lyr_3400900007_14.set('fieldAliases', {'fid': 'fid', 'id': 'id', });
...
lyr_to__13.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', });
lyr_3400900007_14.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', });
...
lyr_to__13.set('fieldLabels', {'fid': 'no label', 'id': 'no label', });
lyr_3400900007_14.set('fieldLabels', {'fid': 'no label', 'id': 'no label', });
lyr_3400900007_14.on('precompose', function(evt) {
