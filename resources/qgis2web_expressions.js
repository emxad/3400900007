...
function exp_label__6_eval_expression(context) {
    // 'تبريد وتكيف'
...
function exp_label__7_eval_expression(context) {
    // 'ميكانيكا سيارات'

    var feature = context.feature;
    
    if (feature.properties) {
        return 'ميكانيكا سيارات';
    } else {
        return 'ميكانيكا سيارات';
    }
}
...
function exp_label__8_eval_expression(context) {
    // 'سمكرة ودهان'
...
function exp_label__9_eval_expression(context) {
    // 'الاكترونيات'
...
function exp_label__10_eval_expression(context) {
    // 'نجارة عامة'
...
function exp_label__11_eval_expression(context) {
    // 'الكفيتيريا'
...
function exp_label__12_eval_expression(context) {
    // 'شؤون الطلابية'

    var feature = context.feature;
    
    if (feature.properties) {
        return 'شؤون الطلابية';
    } else {
        return 'شؤون الطلابية';
    }
}
...
function exp_label_3400900007_14_eval_expression(context) {
    // 3400900007
